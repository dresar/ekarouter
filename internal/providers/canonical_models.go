...
var CanonicalModels = map[string][]ModelInfo{
	...
	"groq": {
		{ID: "openai/gpt-oss-120b", Name: "GPT-OSS 120B", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{ToolCalling: true, Reasoning: true, Streaming: true}},
		{ID: "openai/gpt-oss-20b", Name: "GPT-OSS 20B", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{ToolCalling: true, Reasoning: true, Streaming: true}},
		{ID: "openai/gpt-oss-safeguard-20b", Name: "GPT-OSS Safeguard 20B", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{Streaming: true}},
		{ID: "qwen/qwen3.8-27b", Name: "Qwen 3.8 27B", ContextLimit: 131042, Streaming: true, Capabilities: Capabilities{Vision: true, ToolCalling: true, Streaming: true}},
		{ID: "groq/compound", Name: "Groq Compound (Agentic)", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{ToolCalling: true, Reasoning: true, Streaming: true}},
		{ID: "groq/compound-mini", Name: "Groq Compound Mini", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{ToolCalling: true, Reasoning: true, Streaming: true}},
		{ID: "allam-2-7b", Name: "Allam 2 7B", ContextLimit: 131072, Streaming: true, Capabilities: Capabilities{Streaming: true}},
		{ID: "canopylabs/orpheus-v1-english", Name: "Orpheus v1 English", ContextLimit: 4000, Streaming: false},
		{ID: "canopylabs/orpheus-arabic-saudi", Name: "Orpheus Arabic Saudi", ContextLimit: 4000, Streaming: false},
		{ID: "whisper-large-v3-turbo", Name: "Whisper Large v3 Turbo", ContextLimit: 0, Streaming: false},
		{ID: "whisper-large-v3", Name: "Whisper Large v3", ContextLimit: 0, Streaming: false},
		{ID: "meta-llama/llama-prompt-guard-2-86m", Name: "Llama Prompt Guard 2 86M", ContextLimit: 8192, Streaming: false},
		{ID: "meta-llama/llama-prompt-guard-2-22m", Name: "Llama Prompt Guard 2 22M", ContextLimit: 8192, Streaming: false},
	},
	"openrouter": {
