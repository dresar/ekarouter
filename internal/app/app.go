...
func Setup(cfg *config.Config, migrationsDir string) (*Application, error) {
	...
	registry.Register("xai", custom.NewBackendAdapter("xai", sharedClient))
	registry.Register("grok-cli", custom.NewBackendAdapter("xai", sharedClient))
	registry.Register("sambanova", custom.NewBackendAdapter("sambanova", sharedClient))
	registry.Register("fireworks", custom.NewBackendAdapter("fireworks", sharedClient))
	registry.Register("siliconflow", custom.NewBackendAdapter("siliconflow", sharedClient))
	registry.Register("nebius", custom.NewBackendAdapter("nebius", sharedClient))
	registry.Register("perplexity", custom.NewBackendAdapter("perplexity", sharedClient))
	registry.Register("venice", custom.NewBackendAdapter("venice", sharedClient))
	registry.Register("tencent", custom.NewBackendAdapter("tencent", sharedClient))
	registry.Register("minimax", custom.NewBackendAdapter("minimax", sharedClient))
	registry.Register("glm", custom.NewBackendAdapter("glm", sharedClient))
	registry.Register("cohere", custom.NewBackendAdapter("cohere", sharedClient))
	registry.Register("featherless", custom.NewBackendAdapter("featherless", sharedClient))
	registry.Register("poolside", custom.NewBackendAdapter("poolside", sharedClient))
	registry.Register("byteplus", custom.NewBackendAdapter("byteplus", sharedClient))
	registry.Register("cursor", custom.NewBackendAdapter("cursor", sharedClient))
	registry.Register("windsurf", custom.NewBackendAdapter("windsurf", sharedClient))
	registry.Register("cline", custom.NewBackendAdapter("cline", sharedClient))
	registry.Register("clinepass", custom.NewBackendAdapter("cline", sharedClient))
	registry.Register("trae", custom.NewBackendAdapter("trae", sharedClient))
	registry.Register("zed", custom.NewBackendAdapter("zed", sharedClient))
	registry.Register("qoder", custom.NewBackendAdapter("qoder", sharedClient))
	registry.Register("iflow", custom.NewBackendAdapter("iflow", sharedClient))
	registry.Register("kimi", custom.NewBackendAdapter("kimi", sharedClient))
	registry.Register("kimi-coding", custom.NewBackendAdapter("kimi", sharedClient))
	registry.Register("kilocode", custom.NewBackendAdapter("kilocode", sharedClient))
	registry.Register("codebuddy", custom.NewBackendAdapter("codebuddy", sharedClient))
	registry.Register("codebuddy-cn", custom.NewBackendAdapter("codebuddy", sharedClient))
	registry.Register("codebuddy-intl", custom.NewBackendAdapter("codebuddy", sharedClient))
	registry.Register("azure", custom.NewBackendAdapter("azure", sharedClient))
	registry.Register("vertex", custom.NewBackendAdapter("vertex", sharedClient))
